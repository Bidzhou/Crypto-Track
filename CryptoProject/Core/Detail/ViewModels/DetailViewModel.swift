...
class DetailViewModel: ObservableObject {
    ...
    private func mapDataToStatistics(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> (overview: [StatisticModel], additional: [StatisticModel]){
        ...
        let additionalArray = careateAdditionalArray(coinDetailModel: coinDetailModel, coinModel: coinModel)
    ...
    private func createOverviewAray(coinModel: CoinModel) -> [StatisticModel]{
        ...
        let marketCapStat = StatisticModel(title: "Market Capitalization", value: marketCap, persentageChange: marketCapChange)
    ...
    private func careateAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
