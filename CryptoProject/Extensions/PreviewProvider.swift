...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "MarketCap", value: "$123.321", persentageChange: 25.43)
    let stat2 = StatisticModel(title: "Total Volume", value: "$667Tr")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50.56k", persentageChange: -12.33)
